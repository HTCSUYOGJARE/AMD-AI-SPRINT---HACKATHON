...
if __name__ == "__main__":
    ...
    SELECT_PROMPT1 = True  # Use the first system prompt for answering
    ...
    for idx, (q, a) in enumerate(zip(sample_questions, answer)):
        ...
        try:
            ...
            if all(k in a for k in ['answer', 'reasoning']):
                ...
                a = agent.agent.generate_response(prompt.format(json.dumps(a, indent=2)))
        except json.JSONDecodeError:
