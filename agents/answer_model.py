...
if __name__ == "__main__":
    ...
    response, tl, gt = ans_agent.generate_response("Solve: 2x + 5 = 15 /no_think", system_prompt="You are a math tutor.", tgps_show=True, max_new_tokens=512, temperature=0.1, top_p=0.9, do_sample=True)
